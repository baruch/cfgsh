...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different cfgsh\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"cfgsh's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different cfgsh\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	snprintf(menu_backtitle, 128, "cfgsh v%s Configuration",
	...
	do {
		stat = dialog_yesno(NULL,
				"Do you wish to save your new cfgsh configuration?", 5, 60);
	} while (stat < 0);
	end_dialog();
	...
	if (stat == 0) {
		conf_write(NULL);
		printf("\n\n"
			"*** End of cfgsh configuration.\n"
			"*** Check the top-level Makefile for additional configuration options.\n\n");
	} else
		printf("\n\nYour cfgsh configuration changes were NOT saved.\n\n");
